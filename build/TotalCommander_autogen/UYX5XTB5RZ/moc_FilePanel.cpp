...
template <> constexpr inline auto FilePanel::qt_create_metaobjectdata<qt_meta_tag_ZN9FilePanelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'activated'
        QtMocHelpers::SignalData<void(FilePanel *)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
...
void FilePanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->activated((*reinterpret_cast<std::add_pointer_t<FilePanel*>>(_a[1]))); break;
        case 2: _t->onDoubleClicked((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FilePanel::*)(const QString & )>(_a, &FilePanel::pathChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FilePanel::*)(FilePanel * )>(_a, &FilePanel::activated, 1))
            return;
    }
}
...
// SIGNAL 0
void FilePanel::pathChanged(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void FilePanel::activated(FilePanel * _t1)
{
